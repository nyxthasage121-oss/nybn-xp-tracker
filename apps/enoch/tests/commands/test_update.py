...
from enoch.character.update.parse import update
...
def mock_update_display():
    ...
    with patch("Enoch.character.update.parse.display", new_callable=AsyncMock) as mock:
        yield mock
...
async def test_update_with_custom_fields(
    ...
    from enoch.character.display import DisplayField
