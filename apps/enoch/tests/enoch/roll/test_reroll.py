"""Tests for Enoch/roll/roll.py reroll strategy functions."""

from unittest.mock import patch


from enoch.roll.roll import (
    _avoid_messy,
    _maximize_criticals,
    _reroll_failures,
    _risky_avoid_messy,
...
def test_reroll_failures_all_failures():
    ...
    dice = [1, 2, 3, 4, 5]
    with patch("Enoch.d10", side_effect=[7, 8, 9]):
        result = _reroll_failures(dice)
...
def test_reroll_failures_max_three():
    ...
    dice = [1, 2, 3, 4, 5]
    with patch("Enoch.d10", side_effect=[10, 10, 10]):
        result = _reroll_failures(dice)
...
def test_reroll_failures_mixed():
    ...
    dice = [2, 6, 3, 8, 1]
    with patch("Enoch.d10", side_effect=[9, 7, 6]):
        result = _reroll_failures(dice)
...
def test_reroll_failures_exactly_three_failures():
    ...
    dice = [1, 2, 3, 6, 7]
    with patch("Enoch.d10", side_effect=[8, 9, 10]):
        result = _reroll_failures(dice)
...
def test_reroll_failures_one_failure():
    ...
    dice = [5, 6, 7, 8]
    with patch("Enoch.d10", return_value=10):
        result = _reroll_failures(dice)
...
def test_avoid_messy_all_criticals():
    ...
    dice = [10, 10, 10, 10]
    with patch("Enoch.d10", side_effect=[5, 6, 7]):
        result = _avoid_messy(dice)
...
def test_avoid_messy_exactly_three_criticals():
    ...
    dice = [10, 10, 10, 6, 7]
    with patch("Enoch.d10", side_effect=[1, 2, 3]):
        result = _avoid_messy(dice)
...
def test_avoid_messy_one_critical():
    ...
    dice = [5, 6, 7, 10]
    with patch("Enoch.d10", return_value=8):
        result = _avoid_messy(dice)
...
def test_avoid_messy_mixed_pool():
    ...
    dice = [2, 10, 6, 10, 8]
    with patch("Enoch.d10", side_effect=[3, 4]):
        result = _avoid_messy(dice)
...
def test_risky_avoid_messy_all_criticals():
    ...
    dice = [10, 10, 10, 10]
    with patch("Enoch.d10", side_effect=[5, 6, 7, 8]):
        result = _risky_avoid_messy(dice)
...
def test_risky_avoid_messy_two_criticals_one_failure():
    ...
    dice = [10, 10, 2, 6, 7]
    with patch("Enoch.d10", side_effect=[5, 5, 5]):
        result = _risky_avoid_messy(dice)
...
def test_risky_avoid_messy_exact_count():
    ...
    with patch("Enoch.d10", side_effect=[6, 7, 8]):
        result = _risky_avoid_messy(dice)
