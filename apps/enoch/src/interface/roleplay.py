...
import db
from interface import UpdateOne
import enoch
import interface
import services
...
class RoleplayCog(commands.Cog):
    ...
    @Enoch.options.char_option("The character to post as")
    ...
    async def tags(self, ctx: discord.ApplicationContext):
        ...
        await Enoch.roleplay.show_tags(ctx)
    ...
    async def bookmarks(self, ctx: discord.ApplicationContext):
        ...
        await Enoch.roleplay.show_bookmarks(ctx)
    ...
    async def edit_rp_post(self, ctx: discord.ApplicationContext, message: discord.Message):
        ...
        await Enoch.roleplay.edit_post(ctx, message)
    ...
    async def delete_rp_post(self, ctx: discord.ApplicationContext, message: discord.Message):
        ...
        await Enoch.roleplay.delete_message_chain(ctx, message)
