...
class ExperienceCommands(commands.Cog):
    ...
    async def context_experience_list(self, ctx, member: discord.Member):
        ...
        await Enoch.experience.list_events(ctx, None, True, player=member)
    ...
    async def award(
        ...
        await Enoch.experience.award_or_deduct(
    ...
    async def remove_entry(
        ...
        await Enoch.experience.remove_entry(ctx, character, log_index, player=player)
    ...
    async def log(
        ...
        await Enoch.experience.list_events(ctx, character, False, player=player)
    ...
    async def bulk_award_xp(self, ctx):
        ...
        await Enoch.experience.bulk_award_xp(ctx)
