...
class Traits(commands.Cog, name="Trait Management"):
    ...
    async def user_traits(self, ctx, member):
        ...
        await Enoch.traits.show(ctx, None, player=member)
    ...
    @Enoch.options.char_option("The character to modify")
    ...
    async def traits_list(
        ...
        await Enoch.traits.show(ctx, character, player=player)
    ...
    async def traits_update(
        ...
        await Enoch.traits.update(ctx, character, traits)
    ...
    async def delete_traits(
        ...
        await Enoch.traits.delete(ctx, character, traits)
    ...
    async def add_disciplines(
        ...
        await Enoch.traits.add(ctx, character, disciplines, True)
    ...
    async def remove_disciplines(
        ...
        await Enoch.traits.delete(ctx, character, disciplines, True)
    ...
    async def disciplines_update(
        ...
        """Update one or more traits. Traits must already exist (use /traits add)."""
        await Enoch.traits.update(ctx, character, disciplines, True)
    ...
    async def add_specialties(
        ...
        await Enoch.specialties.add(
            ctx,
            character,
            specialties,
            Enoch.specialties.Category.SPECIALTY,
        )
    ...
    async def remove_specialties(
        ...
        await Enoch.specialties.remove(
            ctx,
            character,
            specialties,
            Enoch.specialties.Category.SPECIALTY,
    ...
    async def add_powers(
        ...
        await Enoch.specialties.add(
            ...
            character,
            powers,
            Enoch.specialties.Category.POWER,
        )
