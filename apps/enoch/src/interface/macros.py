...
class Macros(commands.Cog, name="Macro Utilities"):
    ...
    async def vm(
        ...
        await Enoch.macros.roll(ctx, syntax, character)
    ...
    @option(
        ...
        choices=Enoch.options.ratings(0, 5),
        default=0,
    )
    @option(
        "reroll_rouses",
    ...
    async def macro_list(
        ...
        await Enoch.macros.show(ctx, character)
    ...
    async def macro_update(
        ...
        await Enoch.macros.update(ctx, character, macro, parameters)
    ...
    async def macro_delete(
        ...
        """Delete a macro."""
        await Enoch.macros.delete(ctx, character, macro)
