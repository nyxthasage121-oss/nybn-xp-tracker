...
from enoch import vr as roll
from services.haven import Haven

__HELP_URL = "https://docs.Enoch.app/command-reference/miscellaneous#probability-calculation"
__STRATEGIES = {
...
def __simulate(params, strategy):
    ...
    for _ in range(trials):
        outcome = Enoch.Roll(params.pool, params.hunger, params.difficulty)
