...
__HELP_URL = "https://docs.Enoch.app/advanced/administration/experience-management"
...
class _ExperienceView(DisablingView):
    ...
    async def apply_xp(self, interaction: discord.Interaction):
        ...
        field = Enoch.character.DisplayField.EXPERIENCE
        await Enoch.character.update(
