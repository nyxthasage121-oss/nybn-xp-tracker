...
class ReturnDocument:
    """Stub for pymongo ReturnDocument (MongoDB not in use)."""
...
class UpdateOne:
    """Stub for pymongo UpdateOne (MongoDB not in use)."""
...
async def guild_left(guild: discord.Guild):
    """Log whenever a guild is deleted or Enoch is kicked from a guild."""
    vguild = await VGuild.get_or_fetch(guild)
    vguild.leave()
