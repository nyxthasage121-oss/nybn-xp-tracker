...
from enoch.character.display import DisplayField, display
from enoch.character.update import paramupdate
...
__HELP_URL = "https://docs.Enoch.app/command-reference/characters/updates"
...
async def update_help(ctx: AppCtx, err: str | None = None, ephemeral=True):
    ...
    embed.set_author(name=Enoch.bot.user.display_name)
    embed.set_thumbnail(url=Enoch.bot.user.avatar)
    ...
    documentation = Button(
        ...
        url="https://docs.Enoch.app/command-reference/characters/updates",
    )
