"""Enoch/headers/update.py - Update RP headers."""
...
__HELP_URL = "https://docs.Enoch.app/command-reference/characters/rp-headers"
...
class _RPHeader(discord.ui.DesignerModal):
    ...
    def __init__(self, character: VChar, *args, **kwargs):
        ...
        mock_title = Enoch.header.header_title(character.name, "Not Blushed", "")
