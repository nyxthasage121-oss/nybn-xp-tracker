...
from enoch.macros import macro_common
from enoch.misc import rouse
from enoch.vr import display_outcome, perform_roll
from services.haven import Haven
from utils import get_avatar

__HUNT_LISTENERS = {}
__HELP_URL = "https://docs.Enoch.app/command-reference/macros/rolling"
...
class _SlakeView(View):
    ...
    async def callback(self, inter: discord.Interaction):
        ...
        if slake_amount == _SlakeView.CANCEL_SLAKE:
            ...
            # await inter.message.delete()
            await Enoch.misc.slake(inter, self.character, slake_amount, edit_message=True)
            await Enoch.reference.resonance(inter, character=self.character.name)
