...
__HELP_URL = "https://docs.Enoch.app/guides/gameplay-shortcuts#applying-stains"
...
async def stain(ctx, character, delta, *, player):
    ...
    try:
        ...
        fields = [("Humanity", Enoch.character.DisplayField.HUMANITY)]
        footer = None
        ...
        if delta > 0 and total_stains > (10 - character.humanity):
            ...
            fields.append(("Willpower", Enoch.character.DisplayField.WILLPOWER))
        ...
        inter = await Enoch.character.display(
