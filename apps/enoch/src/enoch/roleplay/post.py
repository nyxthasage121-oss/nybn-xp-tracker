...
__HELP_URL = "https://docs.Enoch.app/premium/roleposting"
...
class PostModal(discord.ui.Modal):
    ...
    async def _new_rp_post(self, interaction: discord.Interaction):
        ...
        if self.show_header:
            ...
            header_embed = Enoch.header.embed(self.header, self.character, True)
        ...
        if self.show_header:
            await Enoch.header.register(interaction, header_message, self.character)
